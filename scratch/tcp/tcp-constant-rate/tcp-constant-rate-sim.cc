...
main(int argc, char* argv[])
{
    ...
    LogComponentEnable("TcpConstantRate", LOG_LEVEL_INFO);
    ...
    bottleneckLink.SetDeviceAttribute("DataRate", StringValue("4096Kbps"));
    ...
    Config::Set("/NodeList/4/$ns3::TcpL4ProtocolCustom/SocketType", StringValue("ns3::TcpConstantRate"));
